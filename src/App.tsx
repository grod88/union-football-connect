...
import AdminClips from "@/features/clips/presentation/pages/AdminClips";
import ClipsLogs from "@/features/clips/presentation/pages/ClipsLogs";
import ClipsStudio from "@/features/clips/presentation/pages/ClipsStudio";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path={ROUTES.ADMIN_CLIPS} element={<AdminClips />} />
            <Route path={ROUTES.ADMIN_CLIPS_LOGS} element={<ClipsLogs />} />
            <Route path={ROUTES.ADMIN_CLIPS_STUDIO} element={<ClipsStudio />} />
